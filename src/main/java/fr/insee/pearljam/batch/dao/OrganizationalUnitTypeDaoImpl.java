...
public class OrganizationalUnitTypeDaoImpl implements OrganizationalUnitTypeDao{
	...
	public void createOrganizationalUnit(OrganizationalUnitType organizationalUnit) {
		...
		pilotageJdbcTemplate.update(qString, organizationalUnit.getId(), organizationalUnit.getLabel(), organizationalUnit.getType());
	}
	...
	public void createOrganizationalUnitFromDto(OrganizationUnitDto organizationalUnit) {
		...
		pilotageJdbcTemplate.update(qString, organizationalUnit.getCodeEtab(), organizationalUnit.getNomEtab(), "LOCAL", organizationalUnit.getOrigineEtab());
	}
