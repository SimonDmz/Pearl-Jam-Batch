...
public class TestsEndToEndExtractCampaign {
	...
	public void testScenario1() throws Exception {
		...
		try {
			launcherService.validateLoadClean(BatchOption.EXTRACT, in, OUT);
	...
	public void testScenario2() throws Exception {
		assertEquals(BatchErrorCode.OK_FONCTIONAL_WARNING, launcherService.validateLoadClean(BatchOption.EXTRACT, "src/test/resources/in/extract/testScenarios/extractScenario2", OUT));
	...
	public void testScenario3() throws Exception {
		assertEquals(BatchErrorCode.OK, launcherService.validateLoadClean(BatchOption.EXTRACT, "src/test/resources/in/extract/testScenarios/extractScenario3", OUT));
